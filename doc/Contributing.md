...
1) If this issue is due to download, compilation or installation of the software, be sure to have read [this](https://github.com/JustWhit3/WaveNCC/blob/main/doc/Download%20and%20install.md) document, in which all the passages are explained in detail.
